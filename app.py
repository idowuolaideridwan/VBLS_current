...
def get_db_connection():
    try:
        return pymysql.connect(host='testingcicdserverdb.c1uehec5adgq.us-east-1.rds.amazonaws.com', user='admin',
                               password='testing2day', database='vbls', cursorclass=pymysql.cursors.DictCursor)
